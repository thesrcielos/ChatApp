...
public interface ChatService {
    ...
    PaginatedListObject<MessageResponse> getMessagesBefore(Integer chatId, LocalDateTime beforeDate, Integer size);
    ...
    void markLastMessageSeen(MessageSeenDTO messageSeenDTO);
